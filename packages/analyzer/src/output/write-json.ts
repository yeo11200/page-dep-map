...
import type { ProjectSummary, PageDetail, ApiIndex } from '@page-dep-map/shared';
 ...
 * - {outputDir}/api-index.json           (Phase 1+ of API usage index)
 */
export function writeJson(
  ...
  // Write API usage index — reverse map of endpoint → call sites
  if (apiIndex) {
    fs.writeFileSync(
      path.join(resolvedDir, 'api-index.json'),
